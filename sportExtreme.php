...
$data = Yaml::parseFile('YAML/sportExtreme.yaml');
...
<main class="artistique">
    ...
    <p class="para"><?php echo $artistique['para3']; ?></p>
    ...
    <div class="bas">
        <p class="bas"><?php echo $artistique['para6']; ?></p>
